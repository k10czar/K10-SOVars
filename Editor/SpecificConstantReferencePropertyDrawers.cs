...
[UnityEditor.CustomPropertyDrawer( typeof( IntConstantReference ) )]
public class IntConstantReferencePropertyDrawer : ConstantReferencePropertyDrawer<IntConstantSO, int> { }

[UnityEditor.CustomPropertyDrawer( typeof( DoubleConstantReference ) )]
public class DoubleConstantReferencePropertyDrawer : ConstantReferencePropertyDrawer<DoubleConstantSO, double> { }

[UnityEditor.CustomPropertyDrawer( typeof( LongConstantReference ) )]
public class LongConstantReferencePropertyDrawer : ConstantReferencePropertyDrawer<LongConstantSO, long> { }
